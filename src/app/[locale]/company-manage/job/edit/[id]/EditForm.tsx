        ...
        <form onSubmit={handleSubmit} id="editForm" className="grid sm:grid-cols-2 grid-cols-1 gap-x-[20px] gap-y-[15px]">
          ...
          <div className="sm:col-span-2">
            ...
            <input
              ...
              name="skills"
              id="skills"
              defaultValue={jobDetail.skills.join(", ")}
              className="w-[100%]  border border-[#DEDEDE] rounded-[4px] py-[14px]  px-[15px] font-[500] text-[14px] text-black"
            />
          </div>
          <div className="sm:col-span-2">
            ...
            <input
              ...
              name="expertise"
              id="expertise"
              defaultValue={jobDetail.expertise}
              className="w-[100%]  border border-[#DEDEDE] rounded-[4px] py-[14px]  px-[15px] font-[500] text-[14px] text-black"
            />
          </div>
          <div className="sm:col-span-2">
          ...
          <div className="sm:col-span-2">
            ...
            <TinyMCE editorRef={editorRef} id="description" value={jobDetail.description} />
          </div>
